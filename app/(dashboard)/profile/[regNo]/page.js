...
import ResumeButton from "@/components/ResumeButton"; // ← ADDED
            ...
            <div className="bg-white rounded-xl border border-gray-200">
              <div className="border-b border-gray-200">
                <div className="flex">
                  ...
                  {/* ↓ FIXED: removed duplicate "resumeButton" tab, kept one clean tab */}
                  <button
              ...
              <div className="p-6">
                ...
                {/* ↓ FIXED: was 'resumeButton' mismatch + called missing <ResumeGeneratorSection> */}
